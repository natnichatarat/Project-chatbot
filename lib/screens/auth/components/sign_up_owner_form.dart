...
import 'package:project/screens/Start_owner/start_screen.dart';
      ...
      try {
        ...
        if (userCredential.user != null) {
          ...
          if (mounted) {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                builder: (context) => StartOwnerScreen(),
              ),
            );
          }
        }
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                  e.toString() == 'Exception: Username is already taken'
                        ...
                        TextFormField(
                          ...
                          validator: MultiValidator([
                            ...
                            MinLengthValidator(5,
                                errorText:
                                    "อีเมลต้องมีความยาวอย่างน้อย 5 ตัวอักษร"),
                            MaxLengthValidator(50,
                                errorText:
                                    "อีเมลต้องมีความยาวไม่เกิน 50 ตัวอักษร"),
                          ]),
                          decoration: InputDecoration(
